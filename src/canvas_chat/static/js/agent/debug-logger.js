...
function createComponentLogger(component) {
    return new DebugLogger(component.toUpperCase());
}
...
const reflectionLogger = new DebugLogger('REFLECTION');
const agentLogger = new DebugLogger('AGENT');
...
const createLogger = createComponentLogger;
